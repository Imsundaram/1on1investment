...
export function Hero({ image }: { image?: string }) {
    ...
    return (
        <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center bg-[var(--primary)] text-white overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
                <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight animate-in fade-in zoom-in duration-700">
                    Find Your Dream Property in <br />
                    <span className="text-[var(--secondary)]">Greater Noida & Noida</span>
                </h1>

                <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl shadow-2xl max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
